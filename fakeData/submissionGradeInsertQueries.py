...
# submissiongrade format = grade, seID
...
def submissionGradeFirstFile():
    # opening sql file where queries will be inserted to write to it
    queryInserter = open('insertSubmissionGrade1.sql', 'w+')
    ...
    value = "INSERT INTO SubmissionGrade VALUES"
    ...
    for line in eachLineList:
        ...
        if currLine != 499999:
            ...
            value = "(" + str(line[3].strip()) + ',' + str(seIDValIncrement) + "),\n"
            #print(value)
            queryInserter.write(value)
...
def submissionGradeSecondFile():
    # opening sql file where queries will be inserted to write to it
    queryInserter = open('insertSubmissionGrade2.sql', 'w+')
...
def submissionGradeThirdFile():
    # opening sql file where queries will be inserted to write to it
    queryInserter = open('insertSubmissionGrade3.sql', 'w+')
...
def runAllSubmissionGradeFiles():
    submissionGradeFirstFile() # populates the first file
    submissionGradeSecondFile() # populates the second file
    submissionGradeThirdFile() # populates the third file

runAllSubmissionGradeFiles()
"""
